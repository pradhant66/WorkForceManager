  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#f5f5f5', padding: '2rem 0' }}>
      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={4} sx={{ marginTop: '2rem' }}>
          <Grid item xs={12} md={4}>
            <Card sx={{ ...animationStyle, boxShadow: 3, borderRadius: 2, height: '100%', backgroundColor: '#fff' }}>
              <CardContent>
                <Typography variant="h5" sx={{ fontWeight: 600, marginBottom: '1rem', color: '#111' }}>
                  Manage Employees
                </Typography>
        ...
        >
          <Typography variant="h5" sx={{ marginBottom: '1rem', fontWeight: 600, color: '#111' }}>
